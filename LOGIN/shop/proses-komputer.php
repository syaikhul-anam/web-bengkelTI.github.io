...
<?php
   ...
   if($gambar_shop != "") {
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "INSERT INTO shop_komputer (nama_komputer, harga_komputer, gambar_komputer) VALUES ('$nama_shop',
            ...
            echo "<script> alert ('Ekstensi gambar hanya bisa jpg dan png!');window.location='tambah-komputer.php';</script>";
        }
   }else {
        $query = "INSERT INTO shop_komputer (nama_komputer, harga_komputer) VALUES ('$nama_shop',
        '$harga_shop')";
        $result = mysqli_query($connect, $query);
