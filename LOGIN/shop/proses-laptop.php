...
<?php
   ...
   if($gambar_shop != "") {
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
            ...
            $query = "INSERT INTO shop_laptop (nama_laptop, harga_laptop, gambar_laptop) VALUES ('$nama_shop',
            ...
            echo "<script> alert ('Ekstensi gambar hanya bisa jpg dan png!');window.location='tambah-laptop.php';</script>";
        }
   }else {
        $query = "INSERT INTO shop_laptop (nama_laptop, harga_laptop) VALUES ('$nama_shop',
        '$harga_shop')";
        $result = mysqli_query($connect, $query);
